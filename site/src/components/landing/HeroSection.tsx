...
export default function HeroSection({ data }: HeroSectionProps) {
  ...
  // Ambil gambar dari Strapi atau gunakan fallback array kosong
          ...
          <div className="lg:col-span-5 relative order-2 mt-8 lg:mt-0">
            ...
            <div className="relative w-full h-[400px] lg:h-[500px]">
              ...
              <motion.div
                ...
                <AnimatePresence mode="wait">
                  {hasImages ? (
                    <motion.div
                      ...
                      <img
                        src={getStrapiMedia(heroImages[currentImage].url) || ""}
                        alt="HMTG Activity"
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-200 text-muted-purple font-fraunces">
                      No Images Uploaded
                    </div>
                  )}
                </AnimatePresence>
                ...
                {/* Overlay Gradient */}
                <div className="absolute inset-0 bg-gradient-to-t from-dark-purple/40 to-transparent pointer-events-none" />
              </motion.div>
